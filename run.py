...
from train_net_onl import train_net
...
parser.add_argument('--backbone_model_path',
                    type=str,
                    default='/home/phuong/Downloads/Code/Experiment/mynet/backbone_results/best_epoch.pth',
                    help='load pre-trained backbone')

parser.add_argument('--result_bb_path',
                    type=str,
                    default='/home/phuong/Downloads/Code/Experiment/mynet/backbone_results',
                    help='save pre-trained backbone')
